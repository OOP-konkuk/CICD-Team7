...
|--------|------------------------|------------------------|----------|
| FR-1, FR-2 | RVC가 바닥을 자동으로 청소하며 직진 이동한다 | UC-1: Perform Cleaning | Evident |
...
| **Type** | Primary, Evident |
| **Overview** | 먼지 감지 시 일정 시간 동안 청소 파워를 높인다 |
| **Pre-Requisites** | RVC가 청소 중임 |
| **Typical Courses of Events** | 1. Dust Sensor가 먼지 감지 (True, Periodic) <br/> 2. Clean: Up 명령 (파워업) <br/> 3. 일정 시간 경과 후 Clean: On으로 복귀 |
| **Alternative Courses of Events** | 없음 |
| **Exceptional Courses of Events** | 없음 |
