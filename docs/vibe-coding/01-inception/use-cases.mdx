...
| FR-5 | 먼지 감지 시 청소 파워업 | UC-4: Power Up Cleaning | Hidden |
...
| **Actors** | Digital Clock (Hidden) |
| **Type** | Primary, Hidden |
| **Overview** | Tick 신호 처리 중 먼지가 감지되면 5분 동안 청소 파워를 높인다 |
| **Pre-Requisites** | RVC가 청소 중이며 장애물 없음 |
| **Typical Courses of Events** | 1. Digital Clock Tick 발생 <br/> 2. Dust Sensor 상태 확인 → True <br/> 3. Clean: Up 명령 (파워업) <br/> 4. 5분 경과 후 Clean: On으로 복귀 |
| **Alternative Courses of Events** | 없음 |
| **Exceptional Courses of Events** | 없음 |
